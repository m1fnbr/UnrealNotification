...
namespace UnrealNotification 
{
        ...
        void* __fastcall ExitBypassHook(__int64 a1) { return NULL; }
        void* __fastcall CrashHook(__int64 a1, __int64 a2) { return NULL; }
        void* __fastcall RequestExitBypassHook(unsigned __int8 a1, unsigned __int8 a2) { return NULL; }
        void* __fastcall NotificationHook(wchar_t** a1, unsigned __int8 a2, __int64 a3, char a4) { return NULL; }
